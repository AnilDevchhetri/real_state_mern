  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
        ...
        <p className="text-sm self-center">
          {fileUploadError ? (
            <span className="text-red-700">
              Error Image Upload(Image cant be larger than 2MB)
            </span>
      ...
      <p className="text-red-700 mt-5">
        {showListingError ? "Somthing went wrong" : ""}
      </p>

      {userListings && userListings.length > 0 && (
        <div className="flex flex-col gap-4 ">
            <h1 className=" text-center my-7 text-2xl font-semibold">Your Properties</h1>
          {userListings.map((listing) => (
            <div
              key={listing._id}
              className="border rounded-lg p-3 flex justify-between items-center my-2"
            >
